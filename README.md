...
- **Framework adapters** for LangChain, LangGraph, CrewAI, OpenAI Agents, Pydantic AI, Google ADK, Haystack, Smolagents, Agno, Microsoft Agent Framework, and MCP servers — drop in, no SDK rewrites required.
